...
const dialog = document.querySelector(".dialog-rating");
const openButton = document.getElementById("show-rating")
openButton.addEventListener("click", () => (dialog.open = true));

document.querySelector("wa-dropdown").addEventListener("wa-select", (event) => {
